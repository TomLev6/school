...
class Tk:
    def __init__(self, window: tk.Tk, main_function, unblocking_function, db):
        ...
        self.background_image = tk.PhotoImage(file="C:\\Users\\cyber\\PycharmProjects\\pythonProject1firewall\\backgr.png")
        ...
        # whitelist frame
        self.whitelist_users_count_label = tk.Label(self.window, text=f"Total Users: {self.whitelist_len_data}", font=self.largefont)

        # blacklist frame
        self.blacklist_users_count_label = tk.Label(self.window, text=f"Total Users: {self.blacklist_len_data}", font=self.largefont)
    ...
    def update_whitelist_table(self):
        self.whitelist_len_data = self.db.server_users_count("WhiteList")

    def update_blacklist_table(self):
        self.blacklist_len_data = self.db.server_users_count("BlackList")

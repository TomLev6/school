...
class Tk:
    def __init__(self, window: tk.Tk, main_function, unblocking_function, db):
        ...
        self.server_users_count_label = tk.Label(self.window, text=f"Total Server Requests:\n {self.server_len_data}",
                                                 font=self.largefont)
    ...
    def update_whitelist_listbox(self):
        ...
        """
        i = 1
        for user_ip in self.db.get_all_users("WhiteList"):
            user_ip = str(user_ip).replace(")", "")
            user_ip = str(user_ip).replace("(", "")
            user_ip = str(user_ip).replace(",", "")
            user_ip = str(user_ip).replace("'", "")
    ...
    def update_pc_table(self):
        ...
        :return:
        """
        self.pc_len_data = self.db.server_users_count(self.A)
    ...
    def update_server_table(self):
        ...
        :return:
        """
        self.server_len_data = self.db.server_users_count(self.S)
        self.server_last_data = self.db.get_startdate(self.S)
        self.server_last_packet_label.config(text=f"Last New Request:\n {self.server_last_data}",
                                             font=self.largefont)
        self.server_users_count_label.config(text=f"Total Requests:\n {self.server_len_data}",
                                             font=self.largefont)
  ...
  def log_command(self):
    ...
    def server_packets_command(self):
        ...
        self.server_users_count_label.place(x=230, y=70)
    ...
    def back_btn_from_server_packets(self):
        ...
        self.background_label.place_forget()
        self.server_users_count_label.place_forget()
